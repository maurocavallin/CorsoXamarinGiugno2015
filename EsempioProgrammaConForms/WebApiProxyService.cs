	...
	public class WebApiProxyService
	{
		...
		private async Task<HttpClient> createHttpClientAsync()
		{
			...
			if (handler == null) {
				...
				clientAuth.BaseAddress = new Uri("http://10.123.26.1/ENOPIAVE/Account/LogOn");
			...
			string fullUrl = "http://10.123.26.1/ENOPIAVE/rest/catalogoaof/"; // articolo
		...
		public async Task<List<Articolo>> GetArticoliAsync()
		{
			...
			HttpResponseMessage response = await httpClient.GetAsync ("articolo"); // , httpContent); 
		...
		private static string test = 
			"[{\"art_ID\":\".ALI1PP\",\"art_DESC\":\"BOMBOLA PACCO 16P ALIGAL1   \",\"art_IMG\":\"/ENOPIAVE/Image/GetAttachmentsImage?relativePath=Articolo/Images/_ALI1PP.jpg\\u0026relativePathDefault=/Media/Image/NoArticolo.png\",\"art_IMGNAME\":\"Articolo/Images/_ALI1PP.jpg\",\"art_TIPOLOGIA\":\"PF\",\"art_CODICE\":\".ALI1PP\"}," + 
